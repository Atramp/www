...
// 为每个页面添加一个指示箭头
$(document).ready(function(){$(".section").each(function(a){if(a==($(".section").length-1)){$(this).append('<div class="navigator navigator-up"><i></i></div>')}else{$(this).append('<div class="navigator navigator-down"><i></i></div>')}})});